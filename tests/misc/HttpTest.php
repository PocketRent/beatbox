...
class HttpFunctionsTest extends beatbox\Test {
	...
	public function testHttpBuildUrl() {
		...
		$this->assertEquals('http://example.com:55555/index?s=b&i=0&e=&a[]=1&a[]=2',
								http_build_url('other', 'index'));
		$this->assertEquals('https://example.com/?s=b&i=0&e=&a[]=1&a[]=2',
								http_build_url(['scheme' => 'https', 'port' => 443]));
		$this->assertEquals('http://example.com:55555/index.php/',
								http_build_url(array(
									"path" => "/./up/../down/../././//index.php/.",
									"query" => null
								), null, HTTP_URL_SANITIZE_PATH|HTTP_URL_FROM_ENV));
