...
if (!defined('PASSWORD_DEFAULT')) {
	...
	// HipHip currently doesn't have blowfish support, so we fallback
	// to SHA512 so we can actually release without it but seemlessly
	// switch when it is supported.
	define('PASSWORD_SHA512', -1);
	define('PASSWORD_BCRYPT', 1);
	if (defined('CRYPT_BLOWFISH') && CRYPT_BLOWFISH)
		define('PASSWORD_DEFAULT', PASSWORD_BCRYPT);
	else
		define('PASSWORD_DEFAULT', PASSWORD_SHA512);
	...
	function password_get_info(string $hash) : array {
		...
		} else if (substr($hash, 0, 3) == '$6$' && strlen($hash) == 106) {
